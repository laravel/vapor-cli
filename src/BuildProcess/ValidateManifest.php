...
class ValidateManifest
{
    ...
    protected function warnAboutDeprecations()
    {
        ...
        if (in_array(Manifest::runtime($this->environment), [
            ...
            Helpers::warn(
                'The runtimes "php-7.3", "php-7.4", and "php-8.0" are deprecated and support will be fully removed from Vapor on 31 Dec 2023.'
        ...
        if (in_array(Manifest::runtime($this->environment), [
            ...
            Helpers::warn(
                'The runtimes "php-7.4:al2", and "php-7.4:imagick" are deprecated and support will be fully removed from Vapor on 31 Dec 2023.'
        ...
        if (Manifest::runtime($this->environment) === 'php-8.0:al2') {
            Helpers::warn(
                'The runtime "php-8.0:al2" will be deprecated on 26th November 2023 when PHP 8.0 stops receiving security updates.'
                .' From this date, it will not be possible to deploy new environments using this runtime and support will be removed for existing runtimes on 26 Feb 2024.'
                .' For a full list of supported runtimes, please see: https://docs.vapor.build/1.0/projects/environments.html#runtime'
            );
        }
